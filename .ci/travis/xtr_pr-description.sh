...
LINK_COMMITS=https://api.github.com/repos/rpc-org/test-4445-a/pulls/$PULL_REQUEST/commits
...
if [[ $ISSUE_NUMBER =~ ^#[0-9]+$ ]]; then
    LINK_PR=https://api.github.com/repos/rpc-org/test-4445-a/pulls/$PULL_REQUEST
    LINK_ISSUE=https://api.github.com/repos/rpc-org/test-4445-a/issues/${ISSUE_NUMBER:1}
    REGEXP=($ISSUE_NUMBER\|https://github.com/rpc-org/test-4445-a/issues/${ISSUE_NUMBER:1})
